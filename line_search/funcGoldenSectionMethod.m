% Golden section method to find the optimal x minimizing an n dimensional
% function starting from a given initial point and a given search
% direction and the acceptable tolerance
% Author: Kaivalya Bakshi
function [x_opt_LineSearch] = funcGoldenSectionMethod(func,x,s,eps)
...
[alpha_U, alpha_L] = func_Bracketing(func,x,s);
